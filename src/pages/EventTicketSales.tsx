      ...
      <div className="p-4 max-w-6xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">R$ {stats.grossRevenue.toFixed(2)}</div>
          ...
          <Card className="bg-muted/50">
            ...
            <CardContent>
              <div className="text-2xl font-bold">R$ {(stats.grossRevenue - stats.netRevenue).toFixed(2)}</div>
              <p className="text-xs text-muted-foreground">plataforma + processamento</p>
            </CardContent>
          </Card>
        </div>
