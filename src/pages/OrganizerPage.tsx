      ...
      <div className="-mt-16 relative z-10">
        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="p-4 bg-card rounded-lg space-y-4">
            ...
            })} className="w-full mt-1 px-3 py-2 bg-background border border-border rounded-lg text-foreground" placeholder="Descrição curta" />
            </div>
            ...
            })} className="w-full mt-1 px-3 py-2 bg-background border border-border rounded-lg text-foreground" placeholder="Descrição detalhada do seu trabalho" rows={3} />
            </div>
