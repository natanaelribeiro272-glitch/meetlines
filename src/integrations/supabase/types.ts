  ...
  public: {
    Tables: {
      ...
      organizer_stories: {
        ...
        Relationships: [
          {
            foreignKeyName: "organizer_stories_organizer_id_fkey"
            columns: ["organizer_id"]
            isOneToOne: false
            referencedRelation: "organizers"
            referencedColumns: ["id"]
      ...
      organizer_story_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "organizer_story_likes_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "organizer_stories"
            referencedColumns: ["id"]
          },
        ]
      }
      organizer_story_views: {
        Row: {
          id: string
          story_id: string
          viewed_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "organizer_story_views_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "organizer_stories"
            referencedColumns: ["id"]
